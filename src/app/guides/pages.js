...
import { BookOpen, ChevronRight, Rocket, CheckCircle, Users } from "lucide-react";
...
export default function Guides() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100 text-slate-900 font-[Inter] text-[12px]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4">
            Master Productivity with{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
              TaskFlow Guides
            </span>
          </h1>
          <p className="text-slate-600 mb-6 max-w-md leading-relaxed">
            Explore our comprehensive guides to unlock the full potential of TaskFlow. Learn best practices, advanced features, and tips to streamline your workflows.
          </p>
        ...
        >
          ...
          <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-lg shadow-md border border-slate-100">
            <div className="flex items-center">
              ...
              <span className="font-medium text-slate-700">Guides Completed</span>
            </div>
      ...
      {/* Guides Section */}
      <div id="guides" className="relative z-10 bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-2xl font-bold text-slate-900 mb-3">Explore Our Guides</h2>
            <p className="text-slate-600">
              Dive into our curated resources to master TaskFlow’s features, from beginner tutorials to advanced workflows.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Learn how to set up your account, create projects, and manage tasks efficiently with our beginner’s guide.",
              },
              {
                icon: <Rocket className="h-6 w-6 text-indigo-600" />,
                title: "Advanced Automation Techniques",
                desc: "Discover how to use TaskFlow’s automation engine to streamline repetitive tasks and boost productivity.",
              },
              {
                icon: <Users className="h-6 w-6 text-indigo-600" />,
                title: "Team Collaboration Best Practices",
                desc: "Master real-time collaboration with shared boards, updates, and integrated communication tools.",
              },
              {
                icon: <CheckCircle className="h-6 w-6 text-indigo-600" />,
                title: "Optimizing Task Prioritization",
                desc: "Use AI-powered categorization to prioritize tasks and keep your projects on track.",
              },
      ...
      <div className="relative z-10 py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-indigo-700 to-purple-700 text-center text-white">
        ...
        >
          ...
          <p className="opacity-90 mb-6 max-w-xl mx-auto">
            Start using TaskFlow today and apply the knowledge from our guides to transform your team’s workflows.
          </p>

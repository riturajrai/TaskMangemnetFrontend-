...
import { Zap, ChevronRight, Workflow, Settings } from "lucide-react";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center px-2 py-1 rounded-full font-medium bg-indigo-100 text-indigo-700 mb-4">
            <Zap className="h-3 w-3 mr-1 text-indigo-600" />
            Automate with Ease
          </div>
          ...
          <p className="text-slate-600 mb-6 max-w-md leading-relaxed">
            Automate repetitive tasks and integrate seamlessly with your tools using TaskFlow’s powerful automation engine.
          </p>
        ...
        >
          ...
          <Image
            src={taskManagement}
            alt="TaskFlow Automation Dashboard"
          ...
          <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-lg shadow-md border border-slate-100">
            <div className="flex items-center">
              ...
              <span className="font-medium text-slate-700">Tasks Automated</span>
            </div>
            <div className="text-lg font-bold text-slate-900 mt-1">85%</div>
          </div>
        </motion.div>
      </div>

      {/* Automation Features Section */}
      <div id="automation" className="relative z-10 bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-slate-600">
              Discover how TaskFlow’s automation tools eliminate manual work, enhance efficiency, and integrate with your favorite apps.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Create tailored automation rules to streamline repetitive tasks and optimize your processes.",
              },
              {
                icon: <Zap className="h-6 w-6 text-indigo-600" />,
                title: "Smart Triggers",
                desc: "Set up intelligent triggers to automate actions based on task updates, deadlines, or events.",
              },
              {
                icon: <Settings className="h-6 w-6 text-indigo-600" />,
                title: "Seamless Integrations",
                desc: "Connect TaskFlow with tools like Slack, Google Workspace, and more for unified workflows.",
              },
              {
                icon: <Zap className="h-6 w-6 text-indigo-600" />,
                title: "Automated Notifications",
                desc: "Receive real-time alerts and reminders to keep your team informed and on track.",
              },
      ...
      <div className="relative z-10 py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-indigo-700 to-purple-700 text-center text-white">
        ...
        >
          ...
          <p className="opacity-90 mb-6 max-w-xl mx-auto">
            Start using TaskFlow’s automation features today to save time and boost productivity across your team.
          </p>

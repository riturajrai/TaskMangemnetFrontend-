...
import { BarChart3, ChevronRight, PieChart, TrendingUp, Activity } from "lucide-react";
...
export default function Analytics() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100 text-slate-900 font-[Inter] text-[12px]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-slate-600 mb-6 max-w-md leading-relaxed">
            Gain deep visibility into your team’s performance with TaskFlow’s advanced analytics, featuring customizable dashboards and real-time reports.
          </p>
        ...
        >
          ...
          <Image
            src={taskManagement}
            alt="TaskFlow Analytics Dashboard"
          ...
          <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-lg shadow-md border border-slate-100">
            <div className="flex items-center">
              <PieChart className="w-3 h-3 text-indigo-600 mr-1" />
              <span className="font-medium text-slate-700">Analytics Accuracy</span>
            </div>
      ...
      <div id="analytics" className="relative z-10 bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-slate-600">
              Leverage TaskFlow’s analytics tools to track performance, identify trends, and make data-driven decisions with ease.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Create tailored dashboards to visualize key metrics and monitor project progress in real time.",
              },
              {
                icon: <TrendingUp className="h-6 w-6 text-indigo-600" />,
                title: "Performance Trends",
                desc: "Analyze historical data to identify productivity trends and optimize team performance.",
              },
              {
                icon: <PieChart className="h-6 w-6 text-indigo-600" />,
                title: "Task Distribution Insights",
                desc: "Understand task allocation across teams to balance workloads and improve efficiency.",
              },
              {
                icon: <Activity className="h-6 w-6 text-indigo-600" />,
                title: "Real-Time Reporting",
                desc: "Access up-to-date reports to make informed decisions and stay ahead of project milestones.",
              },
      ...
      <div className="relative z-10 py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-indigo-700 to-purple-700 text-center text-white">
        ...
        >
          ...
          <p className="opacity-90 mb-6 max-w-xl mx-auto">
            Start using TaskFlow’s analytics tools today to monitor performance and drive smarter decisions.
          </p>

...
import { Users, ChevronRight, MessageSquare, Share2 } from "lucide-react";
...
export default function Collaboration() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100 text-slate-900 font-[Inter] text-[12px]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-slate-600 mb-6 max-w-md leading-relaxed">
            Foster seamless collaboration with real-time task sharing, integrated communication, and team-focused features in TaskFlow.
          </p>
        ...
        >
          ...
          <Image
            src={taskManagement}
            alt="TaskFlow Collaboration Dashboard"
          ...
          <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-lg shadow-md border border-slate-100">
            <div className="flex items-center">
              ...
              <span className="font-medium text-slate-700">Team Engagement</span>
            </div>
      ...
      <div id="collaboration" className="relative z-10 bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-slate-600">
              Boost team productivity with TaskFlow’s collaboration tools, designed for real-time communication and seamless task coordination.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Engage with your team through integrated chat and comment systems directly within tasks.",
              },
              {
                icon: <Share2 className="h-6 w-6 text-indigo-600" />,
                title: "Shared Task Boards",
                desc: "Collaborate on shared boards to track progress and assign tasks in real time.",
              },
              {
                icon: <Users className="h-6 w-6 text-indigo-600" />,
                title: "Team Role Management",
                desc: "Assign roles and permissions to ensure efficient collaboration and task delegation.",
              },
              {
                icon: <MessageSquare className="h-6 w-6 text-indigo-600" />,
                title: "Integrated Feedback Loops",
                desc: "Streamline feedback with in-app notifications and collaborative review tools.",
              },
      ...
      <div className="relative z-10 py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-indigo-700 to-purple-700 text-center text-white">
        ...
        >
          ...
          <p className="opacity-90 mb-6 max-w-xl mx-auto">
            Start using TaskFlow’s collaboration features today to enhance teamwork and streamline project coordination.
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-3">
            ...
            >
              Start Free Trial
              <ChevronRight className="ml-1 h-4 h-4 text-indigo-700" />
            </Link>
            <Link
              href="/demo"
